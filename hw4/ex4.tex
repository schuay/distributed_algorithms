...
% TODO: Proof that only reception of a message can cause a processor to enter
% a univalent state (except if initial state is univalent). This is critical
% to all following proofs.
